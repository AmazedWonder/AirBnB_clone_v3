...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        """Test 'get' retrieves an object of a given class by id."""
        storage = models.storage
        obj = State(name='Georgia')
        obj.save()
    ...
    def test_count(self):
        """Test 'count' counts the number of objects of a given class.
